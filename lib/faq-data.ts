...
export const FAQ_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What is the Meet & Greet service?", a: "It is an optional extra, €5. Your driver waits inside the arrivals hall with your name on their tablet, assists with your luggage from baggage reclaim, and escorts you to the vehicle. Without it your driver waits at the designated meeting point outside, next to the taxi rank where reserved VTC cars may park. Either way, airport pickups include 60 minutes of free waiting from your actual landing time." },
