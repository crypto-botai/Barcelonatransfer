          ...
          <div className="container mx-auto px-4 max-w-2xl">
            ...
            <div className="bg-dark-900 border border-white/[0.08] rounded-xl overflow-hidden overflow-x-auto">
              <table className="w-full text-sm min-w-[420px]">
                ...
                <tbody>
                  {[
                    { vehicle: "Economy sedan (Corolla)",              pax: "1–3", price: "€145" },
                    { vehicle: "Business sedan (EQE 300 / Tesla M3)",   pax: "1–3", price: "€165" },
                    { vehicle: "Minivan (Vito, 4–8 pax)",               pax: "1–8", price: "€180" },
                    { vehicle: "V-Class (7 pax)",                      pax: "1–7", price: "€205" },
                    { vehicle: "Minibus (Sprinter, 9+ pax)",            pax: "9–16", price: "€265" },
                  ].map((row) => (
