...
export async function POST(req: NextRequest) {
  ...
  const kbEntries = [
    ...
    { category: "pricing", question: "How much is a transfer from the airport to Montserrat?", answer: "A private transfer from Barcelona Airport to Montserrat monastery is from **€110** (Economy sedan, excluding VAT and tolls). The journey takes approximately 50 minutes.", tags: ["montserrat", "price"] },
