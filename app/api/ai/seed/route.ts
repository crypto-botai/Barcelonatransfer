...
export async function POST(req: NextRequest) {
  ...
  const kbEntries = [
    // Pricing
    { category: "pricing", question: "How much is a transfer from Barcelona Airport to the city centre?", answer: "Our fixed price for Barcelona Airport (T1 or T2) to the city centre starts from **€50** for an Economy sedan (up to 3 passengers), VAT included. Business class starts from **€60**. No surge pricing — ever.", tags: ["airport", "price", "city"] },
    { category: "pricing", question: "What is the price to Sitges from Barcelona?", answer: "A private transfer from Barcelona city to Sitges costs from **€80** for an Economy sedan. Minivan (4–8 pax) from €110. All prices are fixed and all-inclusive. Airport to Sitges is a custom route — contact us for a confirmed fixed price.", tags: ["sitges", "price"] },
    { category: "pricing", question: "How much is a transfer from the airport to Montserrat?", answer: "A private transfer from Barcelona Airport to Montserrat monastery is from **€95** (Economy sedan, VAT included). The journey takes approximately 50 minutes.", tags: ["montserrat", "price"] },
    { category: "pricing", question: "What is the price to Andorra from Barcelona?", answer: "A private transfer from Barcelona or BCN Airport to Andorra costs from **€300** for an Economy sedan (VAT included). For larger groups, a V-Class starts from €450. Andorra is approximately 3 hours from Barcelona.", tags: ["andorra", "price"] },
    ...
    { category: "pricing", question: "Are there any extra charges or hidden fees?", answer: "No. Our prices are all-inclusive and already include VAT, professional chauffeur, luxury vehicle, tolls, meet & greet, and up to 60 minutes free waiting after landing. The price you see is the price you pay. No surge pricing, no surprises.", tags: ["fees", "hidden", "vat"] },
    ...
    { category: "service", question: "Do you offer transfers from the cruise port?", answer: "Yes. We serve the Barcelona Cruise Terminal. A transfer to/from the city centre starts from **€50** (VAT included). Meet & greet is included at the port gate.", tags: ["cruise", "port", "terminal"] },
