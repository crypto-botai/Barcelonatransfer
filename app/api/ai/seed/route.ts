...
export async function POST(req: NextRequest) {
  ...
  const kbEntries = [
    ...
    { category: "pricing", question: "Are there any extra charges or hidden fees?", answer: "Our fixed fare covers the professional chauffeur, the vehicle and fuel, plus up to 60 minutes of free waiting after landing on airport pickups. Meet & greet, child seats, pet transport and extra stops are optional add-ons, each charged separately. Two things are NOT included: VAT and motorway tolls. Spanish VAT at 10% is added only if you request an invoice, and tolls are charged separately on routes that use toll motorways. Beyond that there is no surge pricing and no hidden fees.", tags: ["fees", "hidden", "vat"] },
